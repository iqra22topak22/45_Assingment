//24_ More Conditional Tests: You don’t have to limit the number of tests you create to 10. If you want to try more comparisons, write more tests. Have at least one True and one False result for each of the following:
...
// test using the lower case function 
  let mixedCaesString :string ="helloworld";
  console.log(mixedCaesString.toLowerCase()==="helloworld");
   let mixedCaesString1 :string ="hello world";
  console.log(mixedCaesString.toLowerCase()!=="helloworld");
